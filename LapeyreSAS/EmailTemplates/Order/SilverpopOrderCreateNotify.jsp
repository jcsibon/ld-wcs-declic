...
<%--
  ...
  * This email JSP page informs the customer that the order has been received by the store.
  * This JSP page is associated with OrderReceivedView view in the struts-config file.    
  *****
--%>
