...
<%--
  ...
  * This email JSP page informs the customer that the order is shipped.
  * This JSP page is associated with ReleaseShipNotifyView view in the struts-config file.    
  *****
--%>
