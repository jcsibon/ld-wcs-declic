...
<head>
	...
	<script type="text/javascript" src="<c:out value="${jsAssetsDir}javascript/ServicesEventMapping.js?${versionNumber}"/>"></script>
	<script type="text/javascript" src="<c:out value='${jsAssetsDir}javascript/MessageHelper.js?${versionNumber}'/>"></script>
	<script type="text/javascript" src="<c:out value='${jsAssetsDir}javascript/CheckoutArea/CheckoutPayments.js?${versionNumber}'/>"></script>
	...
	<wcf:url var="ShoppingCartURL" value="RESTOrderCalculate" type="Ajax">
		...
		<wcf:param name="URL" value="TunnelShopCartView" />
...
<%-- The controllers declaration Javascript file will declare all the controllers without setting URL. URLs are created using <c:url tag and hence cannot be used in JS file. So we have to explicitly set the URL after including controllers...--%>
	...
	<script type="text/javascript" src="<c:out value="${jsAssetsDir}javascript/CommonContextsDeclarations.js?${versionNumber}"/>"></script>
	<script type="text/javascript" src="<c:out value="${jsAssetsDir}javascript/CheckoutArea/ShippingAndBillingControllersDeclaration.js?${versionNumber}"/>"></script>
														...
														<flow:ifEnabled feature="ShowHideOrderItems">
															...
															<div class="orderExpandArea">  
																...
																<c:if test="${empty AddToRequisitionListsJSIncluded}">
																	<script type="text/javascript" src="${staticIBMAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.PDP_AddToRequisitionLists/javascript/AddToRequisitionLists.js"></script>
