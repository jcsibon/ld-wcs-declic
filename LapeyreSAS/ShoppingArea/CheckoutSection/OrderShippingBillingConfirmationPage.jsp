...
<html xmlns="http://www.w3.org/1999/xhtml" lang="${shortLocale}" xml:lang="${shortLocale}">
	<head>
		...
		<link rel="stylesheet" href="<c:out value="${jspStoreImgDir}${env_vfileStylesheetprint}?${versionNumber}"/>" type="text/css" media="print"/>
		...
		<script type="text/javascript" src="<c:out value="${jsAssetsDir}javascript/CheckoutArea/Punchout.js?${versionNumber}"/>"></script>
		...
		<script type="text/javascript" src="${staticIBMAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.csr.OrderComments/javascript/OrderComments.js"></script>
