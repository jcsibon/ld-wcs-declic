...
<c:if test="${empty fromURL}">
	<c:set var="fromURL" value="TunnelShopCartView" />
</c:if>	
...
<%-- Get the CSS to use --%>
<c:set var="css" value="${schemeToUse}://${request.serverName}${jsAssetsDir}${vfileStylesheet}?${versionNumber}"/>
<c:set var="css" value="${fn:substringBefore(css,'.css')}_configurator.css?${versionNumber}"/>
<html>
	<head>
