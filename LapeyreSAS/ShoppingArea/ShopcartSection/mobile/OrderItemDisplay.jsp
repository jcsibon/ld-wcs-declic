...
<html xmlns:wairole="http://www.w3.org/2005/01/wai-rdf/GUIRoleTaxonomy#" xmlns:waistate="http://www.w3.org/2005/07/aaa" lang="${shortLocale}" xml:lang="${shortLocale}">
	<head>
		...
		<link rel="stylesheet" href="${jspStoreImgDir}css/tunnel_mobile.css?${versionNumber}" type="text/css" />
		<!--[if IE 8]>
		...
		<script type="text/javascript" src="${jsAssetsDir}../Widgets-lapeyre/com.lapeyre.declic.commerce.store.widgets.ItemAvailabilityInPhysicalStoresWidget/javascript/ItemAvailabilityInPhysicalStoresWidget.js?${versionNumber}"></script>
						...
						<div id="content" role="main">
							<div class="rowContainer">
								<c:if test="${tunnelStep > 1 && tunnelStep < 5}">
									<!-- Set older style for step 2, 3, 4, 5 of tunnelShopCart after refonte of step 1-->
									<script>
								...
								<c:choose>
									...
									<c:otherwise>
										<div class="row">
											<p class="emptyShopCart"><fmt:message bundle="${storeText}" key="apecuPanierNoProductLabel"/></p>
											<p class="emptyShopCart"><img alt="<fmt:message bundle="${storeText}" key="apecuPanierNoProductLabel"/>" src="${hostPath}${jspStoreImgDir}images/responsive/basketEmpty.png"/></p>
