...
<script type="text/javascript" src='<c:out value="${jsAssetsDir}javascript/StoreLocatorArea/StoreLocator.js?${versionNumber}"/>'></script>
<script type="text/javascript" src='<c:out value="${jsAssetsDir}javascript/StoreLocatorArea/StoreLocatorContextsDeclarations.js?${versionNumber}"/>'></script>
<script type="text/javascript" src='<c:out value="${jsAssetsDir}javascript/StoreLocatorArea/StoreLocatorControllersDeclaration.js?${versionNumber}" />'></script>
<script type="text/javascript" src="<c:out value="${jsAssetsDir}javascript/Common/ShoppingActions.js?${versionNumber}"/>"></script>
...
<div class="gift_content">
	<script type="text/javascript" src="${jspStoreImgDir}javascript/Geolocation.js?${versionNumber}" ></script>
