...
<div id="WC_${formName}_firstName_div_11">
	<input type="text" aria-required="true" name="firstName" id="<c:out value='WC_${pageName}_ShoppingCartAddressEntryForm_${formName}_${paramPrefix}firstName_1'/>" size="35" class="form_input" value="<c:out value='${contact.firstName}'/>" />
</div>
