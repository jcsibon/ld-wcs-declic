										...
										<div id="errorPage">
											...
											<div id="WC_PCE_5" class="content">
												<div id="WC_PCE_6" class="info">						
													...
													<br /><br />
													<div class="ctaContainer column_30 bcolumn_100">
														<a href="#" class="button red" id="WC_ProhibitedCharacterError_Link_1" tabindex="0" onclick="javascript:history.back(1);return false;">
