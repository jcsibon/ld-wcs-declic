			...
			<div id="addr_title"><h2 class="status_msg"><c:out value='${param.nickName}'/></h2></div>
				...
				<div id="WC_AccountForm_div_9">	
					...
					<wcpgl:widgetImport useIBMContextInSeparatedEnv="${isStoreServer}" url="${env_siteWidgetsDir}com.ibm.commerce.store.widgets.AddressForm/AddressForm.jsp">
						<wcpgl:param name="addressId" value="${param.addressId}" />
						<wcpgl:param name="nickName" value="${param.nickName}" />
						<wcpgl:param name="firstName" value="${param.firstName}"/>
						<wcpgl:param name="lastName" value="${param.lastName}"/>
						<wcpgl:param name="middleName" value="${param.middleName}"/>
						<wcpgl:param name="address1" value="${param.address1}"/>
						<wcpgl:param name="address2" value="${param.address2}"/>
						<wcpgl:param name="city" value="${param.city}"/>
						<wcpgl:param name="state" value="${param.state}"/>
						<wcpgl:param name="countryReg" value="${param.countryReg}"/>
						<wcpgl:param name="zipCode" value="${param.zipCode}"/>
						<wcpgl:param name="phone" value="${param.phone}"/>
						<wcpgl:param name="email1" value="${param.email1}"/>
