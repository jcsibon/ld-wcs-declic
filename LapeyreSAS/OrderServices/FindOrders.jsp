...
</wcf:url><fmt:message bundle="${storeText}" key="FIND_ORDERS_CSR" var="contentPageName" scope="request"/>
...
<html xmlns:wairole="http://www.w3.org/2005/01/wai-rdf/GUIRoleTaxonomy#"
	...
	<head>
		...
		<script type="text/javascript" src="${staticIBMAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.csr.FindOrders/javascript/FindByCSRUtilities.js"></script>
		<script type="text/javascript" src="${staticIBMAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.csr.FindOrders/javascript/FindOrders.js"></script>
