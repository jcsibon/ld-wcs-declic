...
({
	...
	ERR_NAME_SHOPPING_LIST : "El nombre Lista de deseos está reservado para la lista de deseos predeterminada. Elija otro nombre.",
	ERR_NAME_DUPLICATE : "Ya existe una lista de deseos con el nombre que ha elegido. Elija otro nombre.",
	INVALID_NAME_SHOPPING_LIST : "El nombre de la lista de deseos contiene caracteres no válidos. Elija otro nombre.",
