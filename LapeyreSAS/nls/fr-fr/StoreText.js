...
({
	...
	ARTICLES: "Articles",
	BRAND: "Marque",
	CATEGORY: "Catégories associées à votre recherche",
	//Product Description
	...
	DEFAULT_WISH_LIST_NAME : "Liste d'achat ",
	LIST_CREATED : "La liste d'achat a été créée avec succès.",
	LIST_EDITED : "Le nom de la liste d'achat a été modifié avec succès.",
	LIST_DELETED : "La liste d'achat a été supprimée avec succès.",
	ITEM_ADDED : "L'article a été ajouté à votre liste d'achat.",
	ITEM_REMOVED : "L'article a été supprimé de votre liste d'achat.",
	ERR_NAME_EMPTY : "Entrez un nom pour votre liste d'achat.",
	ERR_NAME_TOOLONG : "Le nom de votre liste d'achat est trop long.",
	ERR_NAME_SHOPPING_LIST : "Le nom Liste de présélection est réservé à la liste d'achat par défaut. Choisissez un nom différent.",
	ERR_NAME_DUPLICATE : "Une liste d'achat avec le nom que vous avez choisi existe déjà. Choisissez un nom différent.",
	INVALID_NAME_SHOPPING_LIST : "Le nom de votre liste de d'achat  contient des caractères non valides. Choisissez un nom différent.",
	WISHLIST_EMAIL_SENT : "Votre courrier électronique a été envoyé.",
	WISHLIST_MISSINGNAME : "La champ Nom doit être renseigné. Indiquez le nom de votre liste d'achat puis faites une nouvelle tentative.",
	WISHLIST_MISSINGEMAIL : "La zone d'adresse électronique doit être renseignée. Indiquez l'adresse électronique de la personne à laquelle est destinée votre liste d'achat puis faites une nouvelle tentative.",
	WISHLIST_INVALIDEMAILFORMAT : "Format d'adresse électronique incorrect.",
	WISHLIST_EMPTY : "Créez une liste d'achat avant d'envoyer un courrier électronique.",
