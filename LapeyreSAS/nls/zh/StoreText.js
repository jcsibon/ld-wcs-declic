...
({
	...
	DEFAULT_WISH_LIST_NAME : "心愿清单",
	LIST_CREATED : "已成功创建心愿清单。",
	LIST_EDITED : "已成功更改心愿清单名称。",
	LIST_DELETED : "已成功删除心愿清单。",
	ITEM_ADDED : "该商品已添加至心愿清单。",
	ITEM_REMOVED : "已从心愿清单中除去该商品。",
	ERR_NAME_EMPTY : "输入心愿清单的名称。",
	ERR_NAME_TOOLONG : "心愿清单名称太长。",
	ERR_NAME_SHOPPING_LIST : "名称“心愿清单”已保留用于缺省心愿清单。请选择其他名称。",
	ERR_NAME_DUPLICATE : "具有您所选名称的心愿清单已存在。请选择其他名称。",
	INVALID_NAME_SHOPPING_LIST : "名称“心愿清单”包含无效字符。请选择其他名称。",
	WISHLIST_EMAIL_SENT : "您的电子邮件已发送。",
	WISHLIST_MISSINGNAME : "“姓名”字段不能为空。在“姓名”字段中输入您的姓名然后重试。",
	WISHLIST_MISSINGEMAIL : "“电子邮件地址”字段不能为空。请输入您发送心愿清单的人员的电子邮件地址，然后重试。",
	WISHLIST_INVALIDEMAILFORMAT : "无效的电子邮件地址格式。",
	WISHLIST_EMPTY : "在发送电子邮件之前，请先创建心愿清单。",
