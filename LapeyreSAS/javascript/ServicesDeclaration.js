...
function nullCartTotalCookie(orderId){
	...
	* @constructor
     ...
     */
		...
		,successHandler: function(serviceResponse) {
			MessageHelper.hideAndClearMessage();
			//ECOCEA: on n'affiche pas la popup.(normalement on redirige directement vers le panier)
			console.log('item added. Confirmation message not shown');
			...
			//ECOCEA: on n'affiche pas la popup.(normalement on redirige directement vers le panier)
			document.location.href = "TunnelShopCartView?storeId=" + ServicesDeclarationJS.storeId + "&catalogId=" + ServicesDeclarationJS.catalogId + "&langId=" + ServicesDeclarationJS.langId;
		}
     /**
     * display an error message
     * @param (object) serviceResponse The service response object, which is the
   ...
   */
     ...
     */
		,successHandler: function(serviceResponse) {
			MessageHelper.hideAndClearMessage();
			//Mantis 1295: on affiche pas de popin de confirmation de suppression (on recharge la page)
	 ...
	 * Upon a successful request, this function will load the TunnelShopCartView page or the OrderShippingBillingView page depending on what page the service was invoked from. 
	 ...
	 * Upon a successful request, this function will load the TunnelShopCartView page  
	 * An error message will be displayed otherwise.
	 * @constructor
	 */
	wc.service.declare({
