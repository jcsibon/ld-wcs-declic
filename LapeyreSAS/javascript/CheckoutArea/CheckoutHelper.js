...
CheckoutHelperJS={
	...
	deleteFromCart:function(orderItemId,forWishlist){ 
		...
		cursor_wait();
//		tagManager.removeItemFromCart(orderItemId);
		if(y == 1){
	...
	checkoutOrder:function(orderId,userType,addressListForMailNotification,isQuote){
		...
		params["inventoryValidation"] = "false"; //JR52515
	...
	updateCartWait:function(quantityBox, orderItemId, event) {
		...
		setTimeout(dojo.hitch(this, "updateCart", quantityBox, orderItemId, this.keyPressCount[orderItemId], 0), this.updateWaitTimeOut);
	},
	 ...
	 */
	updateCart:function(quantityBox, orderItemId, keyPressCountValue, timeout){
	...
	canCheckoutContinue:function(userType) {
		if ( (dojo.byId("recurringOrder") && dojo.byId("recurringOrder").checked) && ((dojo.byId("shipTypeOnline") && dojo.byId("shipTypeOnline").checked) || dojo.byId("shipTypeOnline") == null)) {
			if (dojo.byId("nonRecurringOrderItems") && dojo.byId("nonRecurringOrderItems").value != "") {
	...
	moveAllItemsToSingleShipment:function(){
		...
		if ((typeof requestedShipDateCheckbox != 'undefined') && (requestedShipDateCheckbox != null)) {
