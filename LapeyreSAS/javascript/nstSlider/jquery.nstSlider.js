...
(function($) {
    ...
    var _methods = {
        ...
        'validate_params' : function (settings) {
            var $this = this;
            var min_value = parseFloat($this.data('range_min')),
                max_value = parseFloat($this.data('range_max')),
                cur_min = parseFloat($this.data('cur_min')),
                lower_limit = parseFloat($this.data('lower-limit')),
                upper_limit = parseFloat($this.data('upper-limit'));
