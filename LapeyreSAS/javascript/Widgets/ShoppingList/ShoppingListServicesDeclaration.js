...
wc.service.declare({
	...
	,successHandler: function(serviceResponse) {
		...
		if(listId!=null){
			listId.value = serviceResponse.giftListId[0];
		}
	}
...
wc.service.declare({
	...
	url:getAbsoluteURL() + "AjaxGiftListServiceUpdateDescription", // TODO améliorer l'appel avec un appel REST url:getAbsoluteURL() + "AjaxRestWishListUpdate",
	formId:""
	...
	,successHandler: function(serviceResponse) {
		cursor_clear();
		closeAllDialogs();
		shoppingListJS.showMessageDialog(storeNLS['LIST_EDITED'],'detail');
...
wc.service.declare({
	...
	,successHandler: function(serviceResponse) {
		cursor_clear();			
		closeAllDialogs();
		shoppingListJS.showMessageDialog(storeNLS['LIST_DELETED'],'list');
...
wc.service.declare({
	...
	,successHandler: function(serviceResponse) {
		...
		shoppingListJS.showMessageDialog(storeNLS['ITEM_REMOVED'],'detail');
	}
...
wc.service.declare({
     ...
     */
		,successHandler: function(serviceResponse) {
			cursor_clear();			
			MessageHelper.hideAndClearMessage();
			shoppingListJS.showMessageDialog(storeNLS['WISHLIST_EMAIL_SENT'],'void');
