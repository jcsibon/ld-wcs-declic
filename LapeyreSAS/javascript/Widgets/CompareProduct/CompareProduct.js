		...
		*/
		...
		remove: function(key){
			...
			if(cookieValue != null){
				...
				this.reloadComparePageOnRemoveProduct(key);
			}
		},
		
		reloadComparePageOnRemoveProduct:function(key) {
		...
		compareProducts:function(){
			var url = "CompareProductsDisplayView?storeId=" + this.params.storeId + "&catalogId=" + this.params.catalogId + "&langId=" + this.params.langId ;
