	...
	ProductTabJS = {
		...
		selectTab: function(tabId){
			...
			//	tab.setAttribute("class", "tab_container inactive_tab");
				dojo.replaceClass(tab, "inactive_tab", "active_tab");
			...
			dojo.replaceClass(dom.byId(tabId), "active_tab", "inactive_tab");
		...
		focusTab: function(tabId){
			if (domClass.contains(tabId,"focused_tab")){
				query("> div",dom.byId(tabId)).style("border","1px dotted transparent");
				return;
			} else {
