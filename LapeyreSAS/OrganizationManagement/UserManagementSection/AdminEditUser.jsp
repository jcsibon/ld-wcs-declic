...
<html xmlns:wairole="http://www.w3.org/2005/01/wai-rdf/GUIRoleTaxonomy#"
	...
	<head>
		...
		<script type="text/javascript" src="<c:out value="${staticIBMAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.RegistrationForm/javascript/B2BLogonForm.js"/>"></script>
		<script type="text/javascript" src="<c:out value="${staticIBMAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.OrganizationList/javascript/OrganizationList.js"/>"></script>
		<script type="text/javascript" src="<c:out value="${staticIBMAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.OrganizationSummary/javascript/OrganizationSummary.js"/>"></script>

		<script type="text/javascript" src="<c:out value="${staticIBMAssetContextRoot}${env_siteWidgetsDir}Common/javascript/WidgetCommon.js"/>"></script>
