...
<html xmlns:wairole="http://www.w3.org/2005/01/wai-rdf/GUIRoleTaxonomy#"
	...
	<head>
		...
		<script type="text/javascript" src="${staticIBMAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.OrganizationMemberApprovalGroups/javascript/OrganizationMemberApprovalGroups.js"></script>
		<script type="text/javascript" src="${staticIBMAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.OrganizationRoles/javascript/OrganizationRoles.js"></script>
		<script type="text/javascript" src="${staticIBMAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.OrganizationSummary/javascript/OrganizationSummary.js"></script>
		<script type="text/javascript" src="${staticIBMAssetContextRoot}${env_siteWidgetsDir}com.ibm.commerce.store.widgets.OrganizationList/javascript/OrganizationList.js"></script>
