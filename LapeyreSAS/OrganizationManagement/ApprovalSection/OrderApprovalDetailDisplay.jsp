...
<fmt:message bundle="${storeText}" key="MYACCOUNT_ORDER_APPROVAL" var="myAccountParentPage" scope="request"/>
<wcf:url var="myAccountParentPageDisplayURL" value="OrderApprovalView" scope="request">
...
<html xmlns:wairole="http://www.w3.org/2005/01/wai-rdf/GUIRoleTaxonomy#"
	...
	<head>
		...
		<title><fmt:message key="MYACCOUNT_APPROVAL_REQUESTS" bundle="${storeText}"/> - <c:out value="${WCParam.orderId}"/></title>
					...
					<div class="rowContainer" id="container_reqList_detail">
						...
						<div class="row margin-true">
							...
							<div class="col8 acol12 ccol9 right">	
								<div id="mainContent_OrderApprovalDetail" role="main" aria-label="<fmt:message key="MYACCOUNT_APPROVAL_REQUESTS" bundle="${storeText}"/>" aria-expanded="true">
									<%out.flush();%>
									<wcpgl:widgetImport useIBMContextInSeparatedEnv="${isStoreServer}" url="${env_siteWidgetsDir}com.ibm.commerce.store.widgets.OrderDetail_Summary/OrderDetail_Summary.jsp">
