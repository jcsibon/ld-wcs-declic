						...
						<div class="row margin-true">
							...
							<div class="col8 acol12 ccol9 right">	
								<div id="mainContent_BuyerApprovalList" role="main" aria-label="<fmt:message key="MYACCOUNT_APPROVAL_REQUESTS" bundle="${storeText}"/>" aria-expanded="true">
									...
									<%out.flush();%>
									<wcpgl:widgetImport useIBMContextInSeparatedEnv="${isStoreServer}" url="${env_siteWidgetsDir}com.ibm.commerce.store.widgets.BuyerApprovalList/BuyerApprovalList.jsp">			
