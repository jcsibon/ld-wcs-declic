...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="${pageContext.request.locale.language}" lang="${pageContext.request.locale.language}">
	<head>
		<c:set var="dojoDir" value="${staticIBMAssetContextRoot}/dojo110"/>
		...
		<script src="${staticIBMAssetContextRoot}/qrcode/js/qrcode.js"></script>
		<script src="${staticIBMAssetContextRoot}/tools/preview/javascript/StorePreviewerHeader.js"></script>
							...
							if(quickInfo != null) {
								...
								if (storeFrame != null) {
									if (storeFrame.document.getElementById("pageNotLayoutManaged") != null) {
										...
										css.setAttribute("href", "${staticIBMAssetContextRoot}/tools/preview/css/store_preview.css");
								...
								"<div class='sp_header_top' style='width: 550px;'>" + 
									"<div id='generateURL_SP_Header' class='sp_header'>" + 										
										...
										"<a id='closeGenerateURL' onkeypress='parent.frames[0].shiftTabToPopupClose(event)' href='javascript:parent.frames[0].hideGenerateURLPopup();'>" +
											"<div class='sp_close'>"+											
											"<img src='${staticIBMAssetContextRoot}/images/preview/storepreview_window_close_icon.png' alt=''/>" +																							
											"</div>" +
										"</a>" +
									"</div>" +
									"<div class='sp_whitespace_background' style='width: 532px;'>" +
										"<div class='sp_content_container'>" +
											...
											"<div id='sp_timeLimit' class='generateURLcontent'>" +
												"<img src='<c:out value='${env_webAlias}'/>/images/preview/extended_help.png' title=\"<fmt:message key='storePreviewGenerateURLActiveTimeTooltip' bundle='${resources}'/>\"/>" +
												"<div class='sp_timeLimitContainer'>" +
													...
													"<div class='sp_errorMessageContainer' id='sp_errorLifespan_container' style='display:none;'>" +
														"<img src='<c:out value='${env_webAlias}'/>/images/preview/error.png'/>" +
											...
											"<div id='sp_passwordURL' class='generateURLcontent'>" +
												"<img src='<c:out value='${env_webAlias}'/>/images/preview/extended_help.png' title=\"<fmt:message key='storePreviewPasswordTooltip' bundle='${resources}'/>\"/>" +
		...
		<style type="text/css">
			...
			.store_preview > .header {
				background: url("${staticIBMAssetContextRoot}/images/preview/header_background_tile.png") repeat-x;
				height: 28px;
				padding-top: 3px;
				width: 100%;
			}
			...
			a.light_button  div.button_text{
				background: url("${staticIBMAssetContextRoot}/images/preview/b_main_bg.png") repeat-x scroll left top transparent;
				float: left;
				height: 17px;
			...
			a.light_button div.button_right {
				background: url("${staticIBMAssetContextRoot}/images/preview/b_right.png") no-repeat scroll 0 0 transparent;
				float: left;
				height: 20px;
				width: 6px;
			}
