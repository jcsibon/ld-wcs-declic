...
<%-- Prevent unwanted XML characters --%>
<c:set var="escapeTopCategory"><c:out value="${WCParam.top_category}" /></c:set> 
...
SearchBasedNavigationDisplayJS.top_category = "${escapeTopCategory}";
...
<%@ include file="/Widgets/Common/StorePreviewShowInfo_End.jspf" %>
	<input id="categoryDescriptionHidden" type="hidden" value="${categoryLongDescription}"></input>
</div>
