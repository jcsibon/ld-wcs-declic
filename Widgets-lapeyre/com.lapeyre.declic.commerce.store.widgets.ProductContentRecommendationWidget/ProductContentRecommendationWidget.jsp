...
<!-- BEGIN ProductContentRecommendationWidget.jsp -->
...
<script type="text/javascript">
	...
	wc.render.declareRefreshController({
		id: "productContentRecommendationRefresh_controller_<c:out value="${param.emsName}" />",
...
<%@ include file="ext/ProductContentRecommendationWidget_Data.jspf" %>
<c:if test = "${param.custom_data ne 'true'}">
	<%@ include file="/Widgets-lapeyre/com.lapeyre.declic.commerce.store.widgets.ContentRecommendation/ContentRecommendation_Data.jspf" %>
	<%@ include file="ProductContentRecommendationWidget_Data.jspf" %>
</c:if>
...
<%@ include file="ext/ProductContentRecommendationWidget_UI.jspf" %>
...
<c:if test = "${param.custom_view ne 'true'}">
	...
	<c:if test="${marketingSpotDatas.behavior == 2}">			
	...
	<c:if test="${!empty catentryIdList}">
		<%@include file="ProductContentRecommendationWidget_Horizontal_UI.jspf"%>
		<%-- 
	...
	<c:if test="${marketingSpotDatas.behavior == 2 && empty WCParam.dontCreateRefreshArea}">
		</div>
	</c:if>
</c:if>
...
<!-- END ProductContentRecommendationWidget.jsp -->