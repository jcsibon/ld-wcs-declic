...
<c:if test = "${param.custom_view ne 'true'}">
	...
	<c:if test="${!empty catentryIdList}">
		<div id="catalogEntryRecommendationContainer">
			<c:choose>
				<c:when test="${isEmspotShowAsList eq true}">
				
				<%@include file="CatalogEntryRecommendationList_Data.jspf"%>
					<%@include file="CatalogEntryRecommendationList_UI.jspf"%>
				</c:when>
			
				<c:when test="${param.widgetOrientation eq 'vertical'}">
					<%@include file="CatalogEntryRecommendation_Vertical_UI.jspf"%>
				</c:when>
				<c:when test="${param.widgetOrientation eq 'horizontal' && isEmspotBestSeller eq true }">
					<%@include file="CatalogEntryRecommendation_Horizontal_BestSellers_UI.jspf"%>
				</c:when>
				<c:when test="${param.isEmspotSelectionOfTheMonth != null && param.isEmspotSelectionOfTheMonth eq true}">
					<%@include file="CatalogEntryRecommendation_Horizontal_SelectionOfTheMonth_UI.jspf"%>
				</c:when>
				<c:otherwise>
