<%--
 ...
 =================================================================
--%>
<%--Cette JSP est la même que GetCatalogEntryDetailsByID.jsp sauf qu'elle crée une div (defaultItemDetailJSON_catentryID) avec le JSON dedans. 
...
<wcf:rest var="catalogNavigationView"  url="${catalogNavigationViewURL}">	
	...
	<%--ECOCEA perf: ici pas besoin des attributs car ils sont définis dans la JSP parente --%>
...
<%--ECOCEA: ne pas appeler l'url catEntryDisplayUrl car ce nom de variable est déja appelé plus bas dans la page--%>
