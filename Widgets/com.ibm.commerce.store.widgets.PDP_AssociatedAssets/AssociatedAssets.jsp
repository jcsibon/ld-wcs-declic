...
<!-- BEGIN AssociatedAssets.jsp -->

<%@ include file="/Widgets/Common/EnvironmentSetup.jspf" %>

<%@ include file="ext/AssociatedAssets_Data.jspf" %>
<c:if test = "${param.custom_data ne 'true'}">
	<%@ include file="AssociatedAssets_Data.jspf" %>
</c:if>

<%@ include file="/Widgets/Common/StorePreviewShowInfo_Start.jspf" %>

<%@ include file="ext/AssociatedAssets_UI.jspf" %>
<c:if test = "${param.custom_view ne 'true'}">
	<%@ include file="AssociatedAssets_UI.jspf" %>
</c:if>

<%@ include file="/Widgets/Common/StorePreviewShowInfo_End.jspf" %>
<jsp:useBean id="AssociatedAssets_TimeStamp" class="java.util.Date" scope="request"/>
