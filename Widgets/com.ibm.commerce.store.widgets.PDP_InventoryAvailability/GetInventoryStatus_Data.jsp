...
{
"onlineInventory": {
	status: "<fmt:message key="INV_STATUS_${onlineInventoryStatus}" bundle="${widgetText}"/>",
	image: "widget_product_info/<fmt:message key="IMG_NAME_${onlineInventoryStatus}" bundle="${widgetText}"/>",
	altText: "<fmt:message key="IMG_INV_STATUS_${onlineInventoryStatus}" bundle="${widgetText}"/>"},
"inStoreInventory": {
